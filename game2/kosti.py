...
root.mainloop()
# для создания exe файла, использовал auto-py-to-exe, но не единым файлом (была ошибка - отказ в доступе), а с папкой,
# потом в папку с игрой, скопировал картинки использованные в коде и все заработало. Игра получилась аж на 18 метров
